...
void Bearing_Rate() 
{
// JNE coding bearing rate used in PID
...
void JNE_AP_Compass_Correction()
{
  ...
  //AVG_Heading = 0.9*AVG_Heading + .1*MAG_Heading ; // low pass filter                            // cfh 21.06.2019 uncommented
  // heading = ToDeg(yaw); // using YAW  use varible heading becuse that is what is used in PID    cfh 21.06.2019 org value commented
  heading = MAG_Heading_Degrees; // using direct compass heading                                  
  //heading = ToDeg(AVG_Heading);  // using low pass filtered compass heading                      // cfh 21.06.2019 uncommented
#endif
